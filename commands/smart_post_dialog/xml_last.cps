 ...
 *
 * Original postprocessor (C) 2012-2025 Autodesk, Inc.
 * SmartPost modifications (C) 2026 MaestroFusion360
 *
 * This modified post is part of the SmartPost project:
 * https://github.com/MaestroFusion360/SmartPost
 *
 * SmartPost modifications are licensed under the Apache License, Version 2.0.
 * Autodesk-originated portions remain subject to their original copyright
 * and applicable Autodesk license terms.
 *
 * Original Autodesk Revision:
 * 44191 10f6400eaf1c75a27c852ee82b57479e7a9134c0
 *
 * Original Date: 2025-08-21 13:23:15
 */
...
function onCycle() {
  ...
  for (var name in cycle) {
    ...
    // The XML importer expects numeric cycle parameters to be floats. Marking
    // integral values as integers corrupts the restored Section movement data.
    var type = "float";
    if (typeof value == "string") {
      type = "string";
    }
